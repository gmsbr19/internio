		...
		<div className="mx-auto w-fit h-full flex flex-col items-center justify-center">
			<div className="card w-96 bg-base-100 shadow-xl">
				<div className="card-body">
					<div className="tabs">
                        {LOGINTYPES.map((e, i) => (
                            <a key={i} className={`tab tab-bordered flex items-center gap-2 ${loginType === e ? "tab-active" : ""}`} onClick={() => setLoginType(e)}>
            ...
            <Link className="text-blue-500 self-start underline" to='/register'>
                Registrar-se
            </Link>
		</div>
	)
